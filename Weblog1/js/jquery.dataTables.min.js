...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Đang xử lý...",sLengthMenu:"Hiển _MENU_ mục",sZeroRecords:"Không tìm thấy kết quả phù hợp",sEmptyTable:"Không có sẵn dữ liệu trong bảng",
sLoadingRecords:"Đang nạp...",sInfo:"Hiển thị từ mục _START_ đến _END_ của _TOTAL_ mục",sInfoEmpty:"Đang hiện từ mục 0 đến 0 của 0 mục",sInfoFiltered:"(Lọc từ _MAX_ mục)",sInfoPostFix:"",sInfoThousands:",",sSearch:"Tìm kiếm:",sUrl:"",oPaginate:{sFirst:"Trang Đầu",sPrevious:"Trước",sNext:"Sau",sLast:"Trang Cuối"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
