...
<link href="../css/comment.css" type="text/css" media="screen" rel="stylesheet">
			...
			<div id="content">			
				<div class="post hentry">
					...
					<div class="post-footer">
						<div><a href="#" title="Hay vãi!"><img src="../images/thumbsup.png" width="35" height="33"></a></div>
					</div><!--end post footer-->
				</div><!--end post-->
				...
				<div id="comments">
					<div class="comment-number">
						...
						<div class="comments"><a href="#respond" title="Leave One ">Để lại phản hồi</a></div>
					</div><!--end comment-number-->
					<ol class="commentlist">
						<li class="comment" id="comment-2">
							<div class="c-grav"><img alt="" src="../images/avatar.jpeg" class="avatar" height="40" width="40"></div>
							<div class="c-body">
								<div class="c-head">
									Vinh <span class="c-permalink"><a href="#comment-2">permalink</a></span>
								</div>
				...
				<div class="js" id="respond">
					<h3 id="reply-title">Gửi phản hồi</h3>
<textarea cols="100" id="editor1" name="editor1" rows="10"></textarea>
		...
		<script type="text/javascript">
			...
			<div class="navigation index">
					<div class="alignleft"><a href="#">«  Bài viết cũ </a></div>
			...
			<div id="sidebar">
				...
				<li class="widget"><h2 class="widgettitle">Chuyên mục</h2>
					<ul>
						<li class="cat-item"><a href="#" title="Xem các bài viết trong mục Uncategorized">Uncategorized</a></li>
					</ul>
				</li>
