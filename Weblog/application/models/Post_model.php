...
class Post_model extends CI_Model {
    ...
    function getPost($mataikhoan) {
    	$this->load->database();
    	$sql = "SELECT bv.mabaiviet, bv.tuade AS tuade, ExtractValue(bv.noidung, '//div[1]|//text()[1]|//p[1]') AS noidung, cm.tenchuyenmuc AS chuyenmuc, DATE_FORMAT( bv.ngaydang, '%Y-%m-%d' ) AS ngaydang
