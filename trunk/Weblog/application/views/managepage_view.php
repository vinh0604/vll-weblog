...
<script>
	$(document).ready(function(){
		...
		$('#insert').click(function(){
			window.location = 'InsertPage.html';
		});
	})
</script>
</head>
...
<div id="content">
    ...
    <div id="content-body">
    <h2 class="title">Quản Lý Trang <input class="content-submit"  type="button" id="insert" value="Thêm Trang"/></h2>
    <div class="right">
            <div class="widget-box">
            	<h3 class="widget-title">Danh Sách Trang</h3>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="all-poll">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeU">
                                ...
                                <td class="center">
                                    <a href="ChangePage.html" title="Sửa Chuyên Mục"><img class="editBtn" src="<?=$base_url()?>images/edit.png" height="32" width="32"></a>
